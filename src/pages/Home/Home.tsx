            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
              <div>
                ...
                <p className="text-gray-400 mb-6">
                  Especialistas em segurança industrial para trabalhos em altura e espaços confinados.
                </p>
                <div className="flex gap-4">
                  <a href="https://www.facebook.com/worksafeserv/" className="text-gray-400 hover:text-primary-light">
                    {/* Ícone do Facebook */}
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                    </svg>
                  </a>
                  <a href="https://www.instagram.com/worksafebrasil/" className="text-gray-400 hover:text-primary-light">
                    {/* Ícone do Instagram */}
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://www.linkedin.com/company/worksafeservicos/" className="text-gray-400 hover:text-primary-light">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <a href="#sobre" className="text-gray-400 hover:text-primary-light">
                      Sobre Nós
                    </a>
                  </li>
                  <li>
                    <a href="#servicos" className="text-gray-400 hover:text-primary-light">
                      Serviços
                    </a>
                  </li>
                  <li>
                    <a href="#produtos" className="text-gray-400 hover:text-primary-light">
                      Produtos
                    </a>
                  </li>
                  <li>
                    <a href="#aluguel" className="text-gray-400 hover:text-primary-light">
                      Aluguel
                    </a>
                  </li>
                  <li>
                    <a href="#treinamentos" className="text-gray-400 hover:text-primary-light">
                      Treinamentos
                    </a>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3 text-gray-400">
                    ...
                    <div>
                      <p>Comercial</p>
                      <p className="text-white">{formatPhoneNumber("81989479259")}</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3 text-gray-400">
