...
export default function Footer() {
  ...
  return (
    <footer className="bg-background/95 backdrop-blur-sm border-t border-border py-20">
      <div className="mx-5 md:mx-20 lg:mx-40 2xl:mx-50 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          <div>
            <div className="mb-6">
              <DynamicLogo width={180} height={60} forceWhite={false} />
            </div>
            ...
            <div className="flex gap-4">
              {company?.facebookUrl && (
                <a href={company.facebookUrl} className="text-muted-foreground hover:text-primary transition-colors">
                {/* Ícone do Facebook */}
              ...
              {company?.instagramUrl && (
                <a href={company.instagramUrl} className="text-muted-foreground hover:text-primary transition-colors">
                {/* Ícone do Instagram */}
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              {company?.linkedinUrl && (
                <a href={company.linkedinUrl} className="text-muted-foreground hover:text-primary transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://www.worksafebrasil.com.br/sobre" className="text-muted-foreground cursor-pointer hover:text-primary transition-colors">
                  Sobre Nós
                </a>
              </li>
              <li>
                <a href="https://www.worksafebrasil.com.br#servicos" className="text-muted-foreground cursor-pointer hover:text-primary transition-colors">
                  Serviços
                </a>
              </li>
              <li>
                <a href="https://www.worksafebrasil.com.br/loja" className="text-muted-foreground cursor-pointer hover:text-primary transition-colors">
                  Loja
                </a>
              </li>
              {/* <li>
                <a href="/#aluguel" className="text-muted-foreground cursor-pointer hover:text-primary transition-colors">
                  Aluguel
                </a>
              </li> */}
              <li>
                <a href="https://www.worksafebrasil.com.br/treinamento" className="text-muted-foreground cursor-pointer hover:text-primary transition-colors">
                  Treinamentos
                </a>
              </li>
            </ul>
