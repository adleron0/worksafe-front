...
// Temporarily replace PaymentIcon with a simple implementation to avoid package issues
const PaymentIcon = ({ type, format, className }: any) => {
  if (format === 'logo') {
    switch(type) {
      case 'Visa':
        return (
          <svg className={className} viewBox="0 0 48 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <text x="12" y="20" fontSize="14" fontWeight="bold">VISA</text>
          </svg>
        );
      case 'Mastercard':
        return (
          <svg className={className} viewBox="0 0 48 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <circle cx="18" cy="16" r="8" fill="currentColor" opacity="0.8"/>
            <circle cx="30" cy="16" r="8" fill="currentColor" opacity="0.6"/>
          </svg>
        );
      case 'Amex':
        return (
          <svg className={className} viewBox="0 0 48 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <text x="8" y="20" fontSize="12" fontWeight="bold">AMEX</text>
          </svg>
        );
      case 'Elo':
        return (
          <svg className={className} viewBox="0 0 48 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <text x="15" y="20" fontSize="14" fontWeight="bold">ELO</text>
          </svg>
        );
      case 'Hipercard':
        return (
          <svg className={className} viewBox="0 0 48 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <text x="4" y="20" fontSize="10" fontWeight="bold">HIPER</text>
          </svg>
        );
      case 'Diners':
        return (
          <svg className={className} viewBox="0 0 48 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <text x="5" y="20" fontSize="11" fontWeight="bold">DINERS</text>
          </svg>
        );
      default:
        return null;
...
export const CreditCardFlipper = ({
  ...
  flipped = false,
  ...props
}: CreditCardFlipperProps & { children?: ReactNode; flipped?: boolean }) => {
    ...
    <CreditCardFlipContext.Provider value={true}>
      ...
      <div
        ...
        className={cn(
          ...
          flipped && '-rotate-y-180 shadow-lg',
          className
        )}
        {...props}
      >
